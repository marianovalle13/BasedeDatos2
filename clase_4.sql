...
SELECT first_name, last_name from actor, film, film_actor WHERE actor.actor_id = film_actor.actor_id AND film_actor.film_id = film.film_id AND film.title = "ZOOLANDER FACTION";
